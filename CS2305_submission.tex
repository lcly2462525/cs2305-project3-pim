...
\citep{hennessy2017computer, stallings2018computer}.
...
\citep{wulf1995memorywall}. This bottleneck is one of the main motivations for
...
To alleviate the performance ceilings of traditional computing, Processing-in-Memory (PIM) has emerged as an alternative architectural paradigm that fundamentally redefines the relationship between computation and storage. Instead of adhering to a strict compute-centric model, PIM integrates computational capabilities directly inside or adjacent to the memory subsystem \citep{sebastian2020memory_woodhead,mutlu2021primer}. The central philosophy of PIM is to shift from a model of bringing data to computation to one of bringing computation closer to data.
